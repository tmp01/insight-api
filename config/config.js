...
if (process.env.INSIGHT_NETWORK === 'livenet') {
  env = 'livenet'; //todo: change port for live site?
  db = home;
  port = '3000';
  b_port = '41353';
  p2p_port = '41353';
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\E-Gold\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/E-Gold/';
  if (isLinux) dataDir = process.env.HOME + '/.E-Gold/';
}
